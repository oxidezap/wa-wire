...
pub const SOURCE_DIGEST: &str =
    "sha256:f5a7f86e75e50c0c45fb5ae2fc8baf1c491a2b2a53ee0becba8189bae1df1410";

/// Tokens addressable by a single byte, indexed from 1.
pub static SINGLE_BYTE: [&str; 236] = [
    "",
    "xmlstreamstart",
    "xmlstreamend",
    "s.whatsapp.net",
...
/// Dictionary 0, addressed by the `DICTIONARY_0` tag plus an index byte.
pub static DICTIONARY_0: [&str; 256] = [
    "read-self",
    "active",
    "fbns",
    "protocol",
...
/// Dictionary 1, addressed by the `DICTIONARY_1` tag plus an index byte.
pub static DICTIONARY_1: [&str; 256] = [
    "reject",
    "dirty",
    "announcement",
    "020",
...
/// Dictionary 2, addressed by the `DICTIONARY_2` tag plus an index byte.
pub static DICTIONARY_2: [&str; 256] = [
    "64",
...
/// Dictionary 3, addressed by the `DICTIONARY_3` tag plus an index byte.
pub static DICTIONARY_3: [&str; 256] = [
    "1724",
    "profile_picture",
    "1071",
    "1314",
